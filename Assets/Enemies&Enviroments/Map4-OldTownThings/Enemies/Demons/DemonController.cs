...
public class DemonController : MonoBehaviour, INPCController
{
    ...
    public void OnDeath()
    {
        ...
        if (gameObject.name == "DemonLead")
        {
            gameObject.GetComponent<DemonLeadAfterDead>().CreateDemon();
        }
        GetComponent<DemonController>().enabled = false;
