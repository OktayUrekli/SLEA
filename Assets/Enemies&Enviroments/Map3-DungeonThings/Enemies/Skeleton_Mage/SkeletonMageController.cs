...
public class SkeletonMageController : MonoBehaviour,INPCController
{
    Animator npcAnimator;
    NavMeshAgent npcNavAgent;

    [Header("View Range Variables")]
    [SerializeField] float turnSpeed = 200; // npc nin playe a doðru dönüþ hýzý
    [SerializeField] float viewRangeRadius = 10; // görüþ alaný yarýçapý
    [SerializeField] LayerMask targetMask;

    [Header("Attack Variables")]
    bool canAttack;
    [SerializeField] float attackRangeRadius = 7; // atak alaný yarýçapý
    ...
    IEnumerator AttackToPlayer(GameObject player)
    {
        ...
        // ateþ topu instantiate edilecek ve buna göre kod yazýlacak
        Instantiate(magicBall, firePoint);
    ...
    public void OnDeath()
    {
        ...
        GetComponent<SkeletonMageController>().enabled = false;
    }
}
